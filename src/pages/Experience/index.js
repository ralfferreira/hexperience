  ...
  return (
    <Container>
      ...
      <ScrollView keyboardShouldPersistTaps="handled">
        ...
        <ExperienceOptions>
          <ExperienceReport onPress={() => { navigation.navigate('ReportExperience')}}>
            <ReportImage source={ReportImg} />
          </ExperienceReport>
          <ExperienceRating>
            <Rating />
          </ExperienceRating>
          <ExperienceCategory name="Pesca" />
        ...
        <ExperienceDetails>
          <ExperienceDetailsRow>
            ...
            <DetailsInput>Fortaleza - CE</DetailsInput>
          </ExperienceDetailsRow>
          <ExperienceDetailsRow>
          ...
          <ExperienceDetailsRow>
            ...
            <DetailsInput>1 hora</DetailsInput>
          </ExperienceDetailsRow>
          <ExperienceDetailsRow>
            <ImageDetails source={AmountPeopleIcon} />
            <DetailsInput>5 pessoas</DetailsInput>
          </ExperienceDetailsRow>
          <ExperienceDetailsRow>
            <ImageDetails source={PriceIcon} />
            <DetailsInput>800,00</DetailsInput>
          </ExperienceDetailsRow>
